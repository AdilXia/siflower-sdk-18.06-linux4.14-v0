...
Category: Network
Repository: base
Title: Mature and flexible open source SIP server, v5.3.0
Maintainer: Jiri Slachta <jiri@slachta.eu>
Require-User: kamailio=380:kamailio=380
Source: kamailio-5.3.0_src.tar.gz
License: GPL-2.0+
LicenseFiles: COPYING
Type: ipkg
Description: Mature and flexible open source SIP server, v5.3.0
...
Submenu: Telephony
Version: 5.3.0-2
Depends: +libc +GCC_LIBSSP:libssp +USE_GLIBC:librt +USE_GLIBC:libpthread kamailio5 @BROKEN +PACKAGE_kamailio5-mod-app-python3:python3-light
Conflicts: 
Menu-Depends: 
Provides: 
Section: net
