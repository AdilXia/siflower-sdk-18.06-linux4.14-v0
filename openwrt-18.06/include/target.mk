...
ifneq ($(findstring EVB,$(PROFILE)),)
  __config_name_list = $(1)/config-$(KERNEL_PATCHVER)_evb $(1)/config-default
endif
...
ifneq ($(findstring FLASH,$(PROFILE)),)
	__config_name_list = $(1)/config-$(KERNEL_PATCHVER)_flash $(1)/config-default
endif

ifneq ($(findstring GMAC,$(PROFILE)),)
	__config_name_list = $(1)/config-$(KERNEL_PATCHVER)_p10m $(1)/config-default
endif

ifneq ($(findstring P10-8M,$(PROFILE)),)
	__config_name_list = $(1)/config-$(KERNEL_PATCHVER)_p10_8m $(1)/config-default
endif
...
ifneq ($(findstring AC20-SJBY,$(PROFILE)),)
    __config_name_list = $(1)/config-$(KERNEL_PATCHVER)_ac20_sjby $(1)/config-default
endif
