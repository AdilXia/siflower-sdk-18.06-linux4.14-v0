...
target_bin="bin/targets/siflower/openwrt-siflower-sf16a18-${chip}-squashfs-sysupgrade.bin"
...
case ${board} in
	...
	x10)
		...
		;;
	p10h)
		target_board=target/linux/siflower/sf16a18_p10h_${chip}_def.config
		;;
	ac20_realtek)
