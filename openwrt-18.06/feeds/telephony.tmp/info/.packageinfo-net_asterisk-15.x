...
Category: Network
Repository: base
Title: Complete open source PBX, v15.7.0
Maintainer: Jiri Slachta <jiri@slachta.eu>
Source: asterisk-15.7.0.tar.gz
License: GPL-2.0
...
Package: asterisk15-res-remb-modifier
Submenu: Telephony
Version: 15.7.0-1
Depends: +libc +GCC_LIBSSP:libssp +USE_GLIBC:librt +USE_GLIBC:libpthread asterisk15
Conflicts: 
...
LicenseFiles: COPYING LICENSE
Type: ipkg
Description: This package provides support for 'REMB modifier' in Asterisk.
http://www.asterisk.org/
Jiri Slachta <jiri@slachta.eu>
@@
